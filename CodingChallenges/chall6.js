...
of the bill if the bill value is between 50 and 300, and if the value is different, the 
tip is 20%.
...
the first tip calculator challenge if you need to). Use the function type you like 
